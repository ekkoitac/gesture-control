...
- [ ] T1-01 [L] Scaffold Python prototype harness
...
- [ ] T1-02 [M] Add webcam debug window
...
- [ ] T1-03 [M] Add hand landmark dry-run
...
- [ ] T2-01 [M] Add activation gesture and hotkey safety
...
- [ ] T2-02 [M] Add index-finger cursor control
...
- [ ] T2-04 [M] Add wave wheel gesture
...
- [ ] T2-05 [M] Add configurable keyboard shortcuts
...
- [ ] T3-01 [M] Add automated verification path
...
- [ ] T3-02 [S] Add manual gesture acceptance checklist
...
- [ ] T3-03 [S] Sync release-ready docs
